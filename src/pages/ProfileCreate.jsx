  ...
  return (
    <div className="h-[82vh] flex justify-center items-center">
      <div className='w-[40vw] flex flex-col justify-center items-center gap-6'>
        ...
        <div class="px-2 py-2 border-green-400 border rounded-xl flex items-center">
          <input className='accent-green-400 border-0 outline-0 ring-0 h-4 w-4 rounded-xl' type="checkbox" id='check' />
          <label className='ml-2' htmlFor="check">Cricket</label>
        </div>
